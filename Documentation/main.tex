...
\begin{enumerate}
    \item \textbf{Committing the changes:} This can be done by clicking on the three dots on the top right corner of the screen, and selecting commit changes. This will save the changes you have made to the repository.
